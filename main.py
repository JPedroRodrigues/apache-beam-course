...
dengue = (
    pipeline
    | "Dengue dataset read" >> ReadFromText("datasets/sample_casos_dengue.txt", skip_header_lines = 1)
...
rain = (
    pipeline
    | "Rain dataset read" >> ReadFromText("datasets/sample_chuvas.csv", skip_header_lines = 1)
